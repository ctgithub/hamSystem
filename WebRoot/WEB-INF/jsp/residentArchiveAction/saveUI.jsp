							...
							<div class="pullbl">
								<span  class="blood_1">
									...
									<input type="radio" name="radio_1" value="1" class="rblood">有
								 	<span  class="tblood" style="display:none;";><input type="text" name="" class="blo-reason" placeholder="请输入输血的原因" size="15px"><input id="calendar-inputField4" size="15px"/></span> 
								</span>
