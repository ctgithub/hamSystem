...
//       }
     ...
     function test(){
    	  ...
    	  var form=document.forms[0];
    	  form.action="family_test.action";
    	  form.submit();
     }
  ...
  <div>
<form name="bt">
<input type="button" onclick="addUI()" name="b1" value="新建"/>
<input type="button" onclick="familyDelete()" name="b2" value="删除"/>
<input type="button" onclick="refresh()" name="b3" value="刷新"/>
<input type="button" onclick="noFamilyList()" name="b4" value="未加入家庭列表"/> 
<input type="button" onclick="exportExcel()" name="b5" value="导出Excel"/>
<input type="button" onclick="test()" name="b6" value="测试" />
</form>
</div>
...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle" border="1">
        ...
        <s:iterator value="#familyList" status="st">
            <tr class="TableDetail1 template" id="#st.index" onclick="do_onclick(this)" 
             >
                ...
                <td>
                        ...
                        <s:a action="family_info?id=%{id}">进入家庭档案</s:a>
                </td>
            </tr>
        </s:iterator> 
